...
export default function FacultyReportCenter() {
  ...
  const fetchReport = useCallback(async () => {
    ...
    try {
      ...
      if (res.success && res.data) {
        ...
        setError(res.message || "Failed to load faculty workload report.");
      }
    } catch (err: any) {
      console.error(err);
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 space-y-6 text-left">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h2 className="text-lg font-bold text-text-primary">Faculty Workload Registers</h2>
            <p className="text-xs text-text-secondary">
              Review and download teaching progress and student aggregates scoped strictly to your workloads.
            </p>
          </div>
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            >
              ...
              <option value="results">Class Academic Results</option>
              <option value="lms">LMS Student Workloads</option>
              <option value="mentorship">Mentorship Registry</option>
              <option value="opportunities">Opportunities Participation</option>
              <option value="teaching">Teaching Planner progress</option>
        ...
        {/* Filter Panel (Scoped to faculty role) */}
        <FilterPanel onApplyFilters={handleApplyFilters} role="faculty" />
        ...
        <div className="bg-surface border border-border-subtle rounded-2xl overflow-hidden shadow-sm">
          {loading ? (
            <div className="py-24 flex flex-col items-center justify-center text-text-muted">
              ...
              <span className="font-mono text-xs">Assembling teaching records...</span>
            </div>
          ) : error ? (
            ...
            <div className="w-full">
              ...
              <div className="px-5 py-4 border-b border-border-subtle bg-surface-elevated/40 flex justify-between items-center">
                <span className="text-xs font-bold text-text-primary uppercase tracking-wider">
                  {reportData.title || "Teaching Ledger"}
                </span>
