        ...
        {loading || fetchingData ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4 flex-1 flex flex-col justify-between">
            <div className="space-y-4">
                ...
                <>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-xs bg-neutral-950 border border-neutral-800 rounded text-white focus:outline-none focus:border-indigo-600 transition"
              ...
              <h4 className="text-[10px] uppercase font-bold text-neutral-500 tracking-wider">Faculty details</h4>
              ...
              <div>
                <label className="block text-[10px] font-bold text-neutral-400 uppercase mb-1">Employee Number <span className="text-rose-500">*</span></label>
                <input
                  type="text"
                  required
                  disabled={!!facultyId}
                  ...
                  className="w-full px-3 py-2 text-xs bg-neutral-950 border border-neutral-800 rounded text-white disabled:opacity-50 focus:outline-none focus:border-indigo-600 transition"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 text-xs bg-neutral-950 border border-neutral-800 rounded text-white focus:outline-none focus:border-indigo-600 transition cursor-pointer"
                >
              ...
              {/* Designation */}
              <div>
                <label className="block text-[10px] font-bold text-neutral-400 uppercase mb-1">Designation <span className="text-rose-500">*</span></label>
                <select
                  required
                  value={designation}
